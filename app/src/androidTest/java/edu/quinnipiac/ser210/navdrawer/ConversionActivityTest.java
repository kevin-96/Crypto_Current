...
public class ConversionActivityTest {
    ...
    @Test
    public void conversionActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.resultTextView), withText("1 BTC is worth: 5479.38994772 USD"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView.check(matches(withText("1 BTC is worth: 5479.38994772 USD")));
    }
